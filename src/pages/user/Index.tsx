...
import WhyChooseUs from "@/pages/sections/WhyChooseUs";
...
const Index = () => {
  ...
  return (
    <div className="space-y-16 py-6">
      ...
      <HeroBanner featuredProducts={featuredProducts} />
      <WhyChooseUs />
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {product.colors.map((color) => (
                                <button
                                  key={color}
                                  className={`px-3 py-1 border rounded-md text-sm ${selectedColor === color
                                    ? "border-crocus-500 bg-crocus-50 text-crocus-700"
                                    : "border-gray-300 hover:border-gray-400"
                                    }`}
