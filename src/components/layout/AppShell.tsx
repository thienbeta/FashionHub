                    ...
                    <div className="flex items-center gap-2">
                      <Link to="/" className="flex items-center gap-2">
                        <img 
                          src="/logo.gif" 
                          alt="FashionHub" 
                          className="h-32 w-auto max-w-[150px]" 
                        />
                      </Link>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {(userRole === "user") && (
                        <>
                          ...
                          <Link to="/user/messages" className={cn(
                            "relative hover:text-crocus-600 transition-colors",
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative translate-y-5">
                      ...
                      <div className="hidden md:block">
                        ...
                        <ul className="space-y-2">
                          <li><Link to="/" className="text-gray-600 hover:text-crocus-500"><LayoutGrid className="h-4 w-4 inline mr-2" /> Trang chủ</Link></li>
                          <li><Link to="/products" className="text-gray-600 hover:text-crocus-500"><ShoppingBag className="h-4 w-4 inline mr-2" /> Sản phẩm</Link></li>
                          <li><Link to="/combos" className="text-gray-600 hover:text-crocus-500"><Package className="h-4 w-4 inline mr-2" /> Combo</Link></li>
                        </ul>
                      </div>
                      <div className="hidden md:block">
                        <h3 className="font-bold text-lg mb-4 text-crocus-700">Tài khoản</h3>
                        <ul className="space-y-2">
                          <li><Link to="/user/profile" className="text-gray-600 hover:text-crocus-500"><UserCircle className="h-4 w-4 inline mr-2" /> Hồ sơ</Link></li>
                          <li><Link to="/user/orders" className="text-gray-600 hover:text-crocus-500"><Package className="h-4 w-4 inline mr-2" /> Đơn hàng</Link></li>
                          <li><Link to="/user/cart" className="text-gray-600 hover:text-crocus-500"><ShoppingCart className="h-4 w-4 inline mr-2" /> Giỏ hàng</Link></li>
                        </ul>
                      </div>
                      <div>
                        <h3 className="font-bold text-lg mb-4 text-crocus-700">Kết nối với chúng tôi</h3>
                        <ul className="space-y-2">
                          <li><Link to="/contact" className="text-gray-600 hover:text-crocus-500"><Mail className="h-4 w-4 inline mr-2" /> Liên hệ</Link></li>
                          <li><Link to="/about" className="text-gray-600 hover:text-crocus-500"><MapPin className="h-4 w-4 inline mr-2" /> Về chúng tôi</Link></li>
                        </ul>
